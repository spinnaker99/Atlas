...
public class LoginActivity extends Activity {
	...
	public boolean onOptionsItemSelected(MenuItem selectedItem){
		if (selectedItem.getItemId() == R.id.menu_forgot_password) {
			Intent browser = new Intent(Intent.ACTION_VIEW, Uri.parse(Constants.FORGOT_PASSWORD_URL));
			startActivity(browser);
		} else if (selectedItem.getItemId() == R.id.menu_create_account) {
			Intent browser = new Intent(Intent.ACTION_VIEW, Uri.parse(Constants.REGISTER_ACCOUNT_URL));
			startActivity(browser);
		}
